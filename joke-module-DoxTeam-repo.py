# name: joke-module-DoxTeam-repo
# source: https://github.com/Heygen100/Module
# source (original): https://github.com/Deseara/D-modules/blob/main/joke_module.py
...
def register(kernel):
    ...
    if kernel.scheduler is not None:
        asyncio.create_task(kernel.scheduler.add_daily_task(send_daily_joke, 12, 0))
