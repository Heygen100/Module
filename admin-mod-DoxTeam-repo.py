...
class Admin(ModuleBase):
    ...
    strings = {
        "ru": {
            ...
            "error": '<blockquote><tg-emoji emoji-id="5260342697075416641">❌</tg-emoji> Внутренняя ошибка. Подробности записаны в журнал.</blockquote>',
        ...
        "en": {
            ...
            "error": '<blockquote><tg-emoji emoji-id="5260342697075416641">❌</tg-emoji> Internal error. Details were written to the log.</blockquote>',
    ...
    async def cmd_mute(self, event: events.NewMessage.Event) -> None:
        ...
        try:
            ...
            await self._edit(event, self.strings("error", err="internal error"))
