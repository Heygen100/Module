...
class DoxModDoxTeam(ModuleBase):
    name = "DoxMod"
    version = "1.0.0"
    author = "@codrago_m, ported to DoxTeam API"
    description = {
        "en": "Interactive DoxTeam database browser/editor",
        "ru": "Редактор базы данных DoxTeam",
        "linux": "DoxTeam /var/lib database browser/editor",
        "rofl": "кринжовый ковырятель базы DoxTeam",
    }
    ...
    strings = {
        ...
        "linux": {
            "del_text": "<b>/var/lib/doxteam/db</b>\n\nSelect inode to inspect",
