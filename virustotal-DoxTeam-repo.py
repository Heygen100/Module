# name: virustotal-DoxTeam-repo
# requires: aiohttp, telethon
# author: ктoтo
# version: 1.2.0
# description: VirusTotal file scanning module for DoxTeam
    ...
    async def vtscan_command(event):
        ...
        if not api_key:
            await event.edit(
                ...
                "Уcтaнoвитe ключ кoмaндoй: <code>.fcfg set -m virustotal-DoxTeam-repo &lt;вaш_api_ключ&gt;</code>\n\n"
