...
This skill is general-purpose Python guidance for OpenAgent. For DoxTeam modules, combine it with the DoxTeam-specific skills and let the DoxTeam conventions win when there is a conflict.
...
## DoxTeam-specific note

DoxTeam is a Telethon-based userbot project. When editing DoxTeam modules or release workflows:

- do not assume Hikka APIs or Hikka module patterns;
- follow `DoxTeam-modules-creator` for module code;
- follow `DoxTeam-release-modules` for publishing and repository commits;
- keep generated Python compatible with the existing DoxTeam runtime and debugger rules.
