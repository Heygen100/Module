...
# ====================================================================================================================
# Repo DoxTeam - https://github.com/hairpin01/repo-DoxTeam-fork
# DoxTeam - https://github.com/hairpin01/DoxTeam-fork
# ====================================================================================================================
#   ██████╗  ██████╗ ██╗   ██╗███╗   ███╗ ██████╗ ██████╗ ██╗   ██╗██╗     ███████╗███████╗
#  ██╔════╝ ██╔═══██╗╚██╗ ██╔╝████╗ ████║██╔═══██╗██╔══██╗██║   ██║██║     ██╔════╝██╔════╝
#  ██║  ███╗██║   ██║ ╚████╔╝ ██╔████╔██║██║   ██║██║  ██║██║   ██║██║     █████╗  ███████╗
...
#   MODULE: Vector (PORT FOR DoxTeam @Hairpin00)
#
...
class Vector(ModuleBase):
    ...
    async def on_load(self) -> None:
        ...
        self._http = aiohttp.ClientSession(
            headers={"User-Agent": "Vector/DoxTeam/2.3.9"},
    ...
    async def vecupdate(self, event: events.NewMessage.Event) -> None:
        ...
        dl_url = "https://raw.githubusercontent.com/hairpin01/repo-DoxTeam-fork/refs/heads/main/Vector-DoxTeam-repo.py"
        if force:
            await event.edit(
