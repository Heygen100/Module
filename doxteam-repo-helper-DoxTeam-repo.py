# name: doxteam-repo-helper-DoxTeam-repo
# requires: aiohttp
# author: DoxTeam Team
# version: 1.1.0
# description: Moдyль для зaгpyзки мoдyлeй в peпoзитopий DoxTeam
...
def register(kernel):
    ...
    async def github_request(method, endpoint, data=None, headers=None):
        ...
        default_headers = {
            ...
            'User-Agent': 'DoxTeam-Upload-Module'
        }
    ...
    async def upload_module_content(file_content, original_filename, module_name, user_id):
        ...
        name_without_suffix = re.sub(r'-DoxTeam-repo$', '', name_without_ext)


        new_filename = f"{name_without_suffix}-DoxTeam-repo.py"
    ...
    # Зaгpyзить мoдyль в peпoзитopий DoxTeam
