...
"""
DoxTeam Studio - main TUI class.

Layout (80 × 24 minimum):

  ┌─ Header bar ──────────────────────────────────────────────────────────────┐
  │  DoxTeam Studio  v2.0.0                                     ? help  q quit   │
...
class Studio:
    """
    Interactive TUI module manager for DoxTeam.
    ...
    def _run(self, stdscr) -> None:
        ...
        self._log("DoxTeam Studio ready  -  press ? for help")
    ...
    def _draw_header(self, win, W: int) -> None:
        ...
        title = f"  DoxTeam Studio  v{self.VERSION}"
        hint  = "? help  q quit  "
    ...
    def _draw_welcome(self, win, y: int, x: int, h: int, w: int) -> None:
        draw_box(win, y, x, h, w, " DoxTeam Studio ", CP_BORDER, CP_HEADER)
