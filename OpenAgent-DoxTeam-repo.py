...
# хе
# repo: https://github.com/hairpin01/repo-DoxTeam-fork/
# -- end --
# requires: aiohttp
# scop: inline
...
_OPENAGENT_LIB_RAW_BASE = (
    "https://raw.githubusercontent.com/hairpin01/repo-DoxTeam-fork/main/lib/OpenAgent"
)
...
def _openagent_fetch_url(url: str) -> bytes:
    ...
    request = Request(url, headers={"User-Agent": "DoxTeam-OpenAgent"})
...
class OpenAgent(
    ...
    strings = {
        "ru": {
            ...
            "status_doxteam": "Выполняю DoxTeam-команду",
        ...
        "en": {
            ...
            "status_doxteam": "Running DoxTeam command",
        ...
        "linux": {
            ...
            "status_doxteam": "doxteam syscall",
    ...
    DoxTeam_DOCS_URL = "https://x0.at/y2rb.md"
        ...
        Group(
            ...
            [
                ...
                ConfigValue(
                    "doxteam_use",
                    False,
                    description="Allow the agent to execute DoxTeam userbot commands",
                    validator=Boolean(default=False),
                ),
                ConfigValue(
                    "doxteam_steps",
                    3,
                    description="Maximum DoxTeam commands per request",
                    validator=Integer(default=3, min=0, max=10),
                ),
                ConfigValue(
            ...
            description="Terminal, web, DoxTeam and Telegram action limits",
            button_text="🛠 Tools",
        ...
        Group(
            ...
            [
                ...
                ConfigValue(
                    ...
                    validator=String(
                        default="https://raw.githubusercontent.com/hairpin01/repo-DoxTeam-fork/main/OpenAgent/skills"
                    ),
                ),
            ],
